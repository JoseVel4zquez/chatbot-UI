                ...
                <div className="w-full flex flex-col md:max-w-xl bg-institucional-purple rounded-tl-lg p-5 rounded-tr-lg shadow-md relative">
                    ...
                    <div className={ isActive ? 'form-summit active':'form-summit'}>
                        <form onSubmit={sendData} className="flex flex-col pt-5">
                            ...
                            <textarea name="" onChange={e=> setPatterns(e.target.value)} placeholder="Patrones" className="bg-white text-gray-700 border-0 rounded-md p-2 mb-4 focus:bg-white focus:outline-none focus:ring-1 focus:ring-yellow-forms transition ease-in-out duration-150" id="" cols="30" rows="10"></textarea>
                            <textarea name="" onChange={e=> setAnswers(e.target.value)} placeholder="Respuestas" className="bg-white text-gray-700 border-0 rounded-md p-2 mb-4 focus:bg-white focus:outline-none focus:ring-1 focus:ring-yellow-forms transition ease-in-out duration-150" id="" cols="30" rows="10"></textarea>
